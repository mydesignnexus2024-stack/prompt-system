          ...
          <div ref={contentRef} className="flex-1 min-w-0 space-y-12">
            ...
            <section id="free-tier" className="scroll-mt-24">
              ...
              <p className="text-sm text-ink-700 leading-relaxed">
                All core features of aiwithrakshith.tech — including the Prompt Vault — are provided completely free of charge. Since no payment is collected for these features, no refund is applicable for free tier usage.
              </p>
            </section>
